...
(function() {
  var Array, Card, Cribbage, Deck, arrayEqual,
    __slice = [].slice;
  ...
  Cribbage = (function() {
    ...
    Cribbage._fifteen = function(cards) {
      var card, card2, cards2, combo, combos, _i, _j, _len, _len1;
      combos = [];
      for (_i = 0, _len = cards.length; _i < _len; _i++) {
        card = cards[_i];
        combo = [card];
        cards2 = cards.filter(function(c) {
          return c.suit !== card.suit || c.number !== card.number;
        });
        for (_j = 0, _len1 = cards2.length; _j < _len1; _j++) {
          card2 = cards2[_j];
  ...
  arrayEqual = function(a, b) {
    return a.length === b.length && a.every(function(elem, i) {
      return elem.suit === b[i].suit && elem.number === b[i].number;
    });
  };
  ...
  Deck = (function() {
    ...
    Deck.prototype.add = function() {
      ...
      cards = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      _results = [];
      for (_i = 0, _len = cards.length; _i < _len; _i++) {
        card = cards[_i];
        _results.push(this.cards.push(card));
      }
      return _results;
    };
