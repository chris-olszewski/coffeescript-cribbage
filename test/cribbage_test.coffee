...
exports.CribbageTest = 
	...
	'3 fives add up to 15': (test) ->
		hand = [new Card('h', 5), new Card('s', 5), new Card('c', 5)]
		points = Cribbage._fifteen hand
		test.equal points, 2
		test.done()
	...
	'perfect hand is worth 29': (test) ->
		hand = [new Card('h', 11), new Card('s', 5), new Card('c', 5), new Card('d', 5), new Card('h', 5)]
		points = Cribbage.points hand
		test.equal points, 29
		test.done()
